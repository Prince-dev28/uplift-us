...
export default function Layout({ children }) {
  ...
  return <div className="min-h-screen gradient-surface flex">
      {
    /* Desktop sidebar */
  }
    ...
    return <Link
      key={item.to}
      to={item.to}
      className={`flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all ${active ? "gradient-calm text-primary-foreground shadow-soft" : "text-muted-foreground hover:bg-muted"}`}
    >
  ...
  >
    ...
    return <Link
      ...
      className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all ${active ? "gradient-calm text-primary-foreground shadow-soft" : "text-muted-foreground hover:bg-muted"}`}
    >
                  <item.icon className="w-4 h-4" />
                  {item.label}
                </Link>;
