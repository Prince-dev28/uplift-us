...
export default function Dashboard() {
  ...
  return <div className="space-y-6">
  ...
  ].map((a, i) => <motion.div key={a.to} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}>
    ...
    /* Mood Chart */
        ...
        <div className="bg-card rounded-2xl p-6 shadow-card border border-border">
          ...
          {moodData.length > 1 ? <ResponsiveContainer width="100%" height={200}>
  ...
  />
            ...
            </ResponsiveContainer> : <div className="h-[200px] flex items-center justify-center text-sm text-muted-foreground">
    ...
    /* Latest Assessment */
        ...
        <div className="bg-card rounded-2xl p-6 shadow-card border border-border">
          ...
          {latestAssessment ? <div className="space-y-4">
              <div className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${latestAssessment.overallLevel === "Low" ? "bg-calm-green text-foreground" : latestAssessment.overallLevel === "Moderate" ? "bg-calm-peach text-foreground" : "bg-calm-rose text-foreground"}`}>
    ...
    { label: "Depression", score: latestAssessment.depressionScore }
            ...
            </div> : <div className="h-[200px] flex items-center justify-center text-sm text-muted-foreground">
    ...
    /* Recent Moods */
      ...
      {moods.length > 0 && <div className="bg-card rounded-2xl p-6 shadow-card border border-border">
          ...
          <div className="flex gap-3 overflow-x-auto pb-2">
            {moods.slice(0, 7).map((m) => <div key={m.id} className="flex flex-col items-center min-w-[60px]">
